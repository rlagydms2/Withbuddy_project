package com.lec.spring.withbuddy_project.config.oauth;

import com.lec.spring.withbuddy_project.config.PrincipalDetails;
import com.lec.spring.withbuddy_project.config.oauth.provider.GoogleUserInfo;
import com.lec.spring.withbuddy_project.config.oauth.provider.KakaoUserInfo;
import com.lec.spring.withbuddy_project.config.oauth.provider.NaverUserInfo;
import com.lec.spring.withbuddy_project.config.oauth.provider.OAuth2UserInfo;
