package com.example.withbuddy_project.config.oauth;

import com.example.withbuddy_project.config.PrincipalDetails;
import com.example.withbuddy_project.config.oauth.provider.GoogleUserInfo;
import com.example.withbuddy_project.config.oauth.provider.KakaoUserInfo;
import com.example.withbuddy_project.config.oauth.provider.NaverUserInfo;
import com.example.withbuddy_project.config.oauth.provider.OAuth2UserInfo;
